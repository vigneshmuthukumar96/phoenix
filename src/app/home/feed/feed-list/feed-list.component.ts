...
export class FeedListComponent implements OnInit {
  ...
  feedJson = [
    ...
    { header: 'PRO PLUS', url: 'assets/images/pro-plus-1.JPG',template:'pro-plus',text:"Bypass protein, Bypass fat and Vitamin AD3 enriched pellet which is recommended for high yielding cows like HF, Jersey, Etc..." },
    { header: 'PRO RICH', url: 'assets/images/pro-rich-2.JPG',template:'pro-rich',text:"Bypass protein, Bypass fat and Vitamin AD3 enriched pellet which is recommended for high yielding cows like HF, Jersey, Etc..."  },
    { header: 'GOLD SPECIAL HI PRO PELLET', url: 'assets/images/pro-pellet-1.JPG',template:'pro-pellet',text:"High protein pellet which is recommended for good yielding cows."  },
    { header: 'BY PASS PELLET', url: 'assets/images/pass-pellet-1.JPG',template:'pass-pellet',text:"Enrich of proteins and vitamins increase digestion."  },
    { header: 'GOLD CALF STARTER', url: 'assets/images/calf-starter-1.JPG',template:'calf-starter',text:"High protein pellet for calf which helps to express  heat within 12-15 months."  },
    { header: 'GOLDEN GOAT FEED', url: 'assets/images/goat-feed-1.JPG',template:'goat-feed',text:"Phoenix Golden goat pellet  isenriched with vitamins, yeast and enzymes."  },
    { header: 'VIN AQUA', url: 'assets/images/vin-aqua-1.JPG',template:'vin-aqua',text:"Balanced & fortified fish feed.Enriched with Vitamins & Micro Nutrients.High Nutrition,Health and Natural."  },
