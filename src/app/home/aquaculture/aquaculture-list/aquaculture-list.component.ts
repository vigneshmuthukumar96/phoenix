...
export class AquacultureListComponent implements OnInit {
  ...
  feedJson = [
    ...
    { header: 'Hull', url: 'assets/images/hull.jpg',template:'goat-feed',text:"Hull is Oil Based Binder by Rand Aqua.A revolutionary product by Rand Aqua which is never before in aquaculture industry. "  },
