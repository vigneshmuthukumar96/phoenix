...
export class DisinfectantListComponent implements OnInit {
  ...
  feedJson = [
    ...
    { header: 'P3DEX', url: 'assets/images/p3dex.jpg',template:'p3dex',text:"Highly recommended for surface Decontamination, Terminal Disinfection, Sanitization of Equipment’s and Vehicle and personal Hygiene" },
